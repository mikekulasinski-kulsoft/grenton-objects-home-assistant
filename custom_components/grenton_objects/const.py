...
CONF_GRENTON_TYPE_RELAY_POWER = 'RELAY_POWER'
CONF_GRENTON_TYPE_ANALOG_SCALED_VALUE = 'ANALOG_SCALED_VALUE_OR_VALUE_%'
CONF_GRENTON_TYPE_PANEL_BUTTON_LED = 'PANEL_BUTTON_LED'
...
CONF_SATEL_TYPE_CONTACT = "CONTACT"
...
SWITCH_GRENTON_TYPE_OPTIONS = [
    CONF_GRENTON_TYPE_DOUT,
    CONF_GRENTON_TYPE_PANEL_BUTTON_LED
]
